...
void pack3d(tarkindata *td, oggpack_buffer *o)
{
  ...
  uint32_t xbit, ybit, vx, vy;
  uint32_t zbase, linaddr, vectorcount;
...
void unpack3d(tarkindata *td, oggpack_buffer *o)
{
  ...
  uint32_t  xbit, ybit, vx, vy;
  uint32_t zbase, linaddr, cidx, vectorcount;
...
void packblock(tarkindata *td, oggpack_buffer *oggb)
{
  ...
  _oggpack_write(oggb, td->vectorcount, sizeof(uint32_t)*8);
...
void unpackblock(tarkindata *td, oggpack_buffer *oggb)
{
  ...
  td->vectorcount = _oggpack_read(oggb, sizeof(uint32_t)*8);
